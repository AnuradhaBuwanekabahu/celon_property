...
import EditStaytorentProfile from '../../../components/EditStaytorentprofile';

const DashboardStaytorentEditProfile = () => {
        ...
        <div className="sm:hidden">
          <DashboardSidebar clientID={id} />
              ...
              <main className="flex-1 overflow-x-hidden p-5">
               <EditStaytorentProfile clientID={id} />
              </main>
...
export default DashboardStaytorentEditProfile