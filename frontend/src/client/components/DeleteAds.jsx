                       ...
                       <div className="mt-6 grid grid-cols-3 gap-5 ml-10">
                                                     ...
                                                     {filteredAds.map((item) => (
                                                             ...
                                                             <div key={item.id}>
                                                                    ...
                                                                    <div className="relative left-24 w-[300px] h-[350px] rounded-xl overflow-hidden shadow-md hover:shadow-xl cursor-pointer" onClick={() => navigate(`/dashboard/ads/view/${item.id}`, { state: { clientID } })}>
