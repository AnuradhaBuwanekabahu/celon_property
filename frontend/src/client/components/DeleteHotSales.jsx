...
const DeleteHotSales =({ clientID }) =>{
   
       const { hotSales, loading, getHotSales ,handleDeleteHotSale} = useContext(clientContext);
                                ...
                                <div className="relative left-24  w-[300px] h-[350px] rounded-xl overflow-hidden shadow-md hover:shadow-xl">
                                                                     ...
                                                                     <div className="absolute bottom-4 left-4 w-[260px] bg-white rounded-2xl p-4">
                                                                       ...
                                                                       <div className="flex items-center justify-between mt-3">
                                                                         ...
                                                                         <Trash2 className='text-red-600' onClick={()=>handleDeleteHotSale(item.id)} />
                                                                         </div>
                                                                       </div>
