...
const Staytorentedit = ({ clientID }) => {
    ...
    const clientStayToRent = stayToRent.filter(
                ...
                filteredStayToRent.length === 0 ? (
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-5 ml-10">
                        ...
                        {filteredStayToRent.map((item)=>(
                            ...
                            <div key={item.id}>
                                  <div
                                   onClick={()=>navigate(`/dashboard/stays-rent/edit-profile/${item.id}`)}
