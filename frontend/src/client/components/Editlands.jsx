...
const EditLands = ({ clientID }) => {

    const navigate =useNavigate();

    const {  loading, lands,getlands} = useContext(clientContext);
                ...
                filteredLands.length === 0 ? (
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-5 ml-10">
                        ...
                        {filteredLands.map((item)=>(
                            ...
                            <div key={item.id}>
                                  <div
                                   onClick={()=>navigate(`/dashboard/lands/edit-profile/${item.id}`)}
