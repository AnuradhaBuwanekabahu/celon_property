...
const DeleteStayTorent = ({ clientID }) => {


    const navigate =useNavigate();
    const {stayToRent, getStayToRent,handleDeleteStaysToRent} = useContext(clientContext);
                                      ...
                                      <div className="absolute bottom-4 left-4 w-[260px] bg-white rounded-2xl p-4">
                                        ...
                                        <div className="flex items-center justify-between mt-3">
                                          ...
                                          <div className="flex items-center gap-1">
                                              <Trash2 className='text-red-600' onClick={()=>handleDeleteStaysToRent(item.id)} />
                                          </div>
                                        </div>
...
export default DeleteStayTorent;