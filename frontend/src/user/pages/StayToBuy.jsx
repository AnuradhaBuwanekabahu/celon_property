...
import { getStayToBuy } from '../services/api'
          ...
          <div className="border border-gray-300 rounded-full lg:rounded-lg mb-6 overflow-hidden">
            ...
            <div className={`space-y-2 text-sm text-gray-600 max-h-32 overflow-y-auto px-4 pb-4 ${openFilter === 'price' ? 'block' : 'hidden'} lg:block`}>
              <label className="flex items-center gap-2">
                <input type="radio" name="price" className="accent-secondary" /> Under Rs. 50M
              </label>
              <label className="flex items-center gap-2">
                <input type="radio" name="price" className="accent-secondary" /> Rs. 50M - 150M
              </label>
              <label className="flex items-center gap-2">
                <input type="radio" name="price" className="accent-secondary" /> Above Rs. 150M
              </label>
              <label className="flex items-center gap-2">
