...
import { hotSalesProperties, housesProperties, apartmentsProperties, hotelsProperties } from '../data/properties'
  ...
  return (
    <div>
      ...
      <div className="relative max-w-5xl mx-auto px-4">
        <div className="bg-navy text-white rounded-xl -mt-8 md:-mt-9 relative z-10 shadow-xl">
      ...
      <PropertySection 
        title="Hot Sales" 
        properties={hotSalesProperties.slice(0, 4)} 
        seeMoreLink="/hot-sales"
      />

      <PropertySection 
        title="Houses" 
        properties={housesProperties} 
        seeMoreLink="/lands"
      />
